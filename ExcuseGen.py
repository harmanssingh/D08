...
def main():
    ...
    personwithexcuse=getRandomParticipantIndex(bootcampParticipants)
    # print person's name who has excuse today.
    name=getPerson(bootcampParticipants,personwithexcuse)
    print(name)
    #
    # print person's name who has excuse today.
